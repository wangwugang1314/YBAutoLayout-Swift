...
class YBController_3: YBBaseController {
    ...
    override func viewDidLoad() {
        ...
        shwoTextArr = [YBCellModel(title: "1. 可以自定义四周边距(上下左右边距)"),
                       ...
                       YBCellModel(title: "4. item的宽高都是根据父试图大小自动约束的"),
                       YBCellModel(title: "5. 可以自定义平铺方向12种，具体看枚举类型"),
                       YBCellModel(title: "6. 可以自定义单排平铺试图的个数")]
    }
